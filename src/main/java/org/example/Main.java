...
public class Main {
    public static void main(String[] args) {
        ...
        List<Country> northernEurope = new ArrayList<>();
        northernEurope.add(poland);
        northernEurope.add(norway);
        northernEurope.add(france);

        List<Country> southernEurope = new ArrayList<>();
        southernEurope.add(italy);
        southernEurope.add(france);
        southernEurope.add(spain);

        Market businessNorth = new Market("business", northernEurope);
        Market cargoNorth = new Market("cargo", northernEurope);
        Market transportSouth = new Market("transport", southernEurope);
        Market taxiSouth = new Market("taxi", southernEurope);
        Market busNorth = new Market("bus", northernEurope);
        ...
        Car car1 = new Car(producer2, true, businessNorth, CarSegment.STANDARD, dimensionsArrayList);
        Car car2 = new Car(producer4, false, cargoNorth, CarSegment.MEDIUM, dimensionsArrayList);
        ...
        Car car5 = new Car(producer8, true, busNorth, CarSegment.MEDIUM, dimensionsArrayList);
        Car car6 = new Car(producer7, false, businessNorth, CarSegment.STANDARD, dimensionsArrayList);
        Car car7 = new Car(producer2, true, cargoNorth, CarSegment.PREMIUM, dimensionsArrayList);
        Car car8 = new Car(producer1, false, taxiSouth, CarSegment.STANDARD, dimensionsArrayList);
        ...
        Car car11 = new Car(producer9, true, cargoNorth, CarSegment.STANDARD, dimensionsArrayList);
        Car car12 = new Car(producer5, false, businessNorth, CarSegment.MEDIUM, dimensionsArrayList);
